...
export function usernameIssue(raw) {
...
export function passwordIssue(password, { username = "", email = "" } = {}) {
...
/** @returns {{ score: number, label: string, issue: string }} score 0–3 */
export function passwordStrength(password, ctx = {}) {
